import {calcSnV1, calcSnV2, calcSnV3} from "./01-02-calcSn";
...
describe('calcSnV1()', () => {
  ...
  test('should return Sum(n) when input is valid', () => {
    expect(calcSnV1(3)).toBe(14);
    expect(calcSnV1(4)).toBe(30);
  });
});
...
describe('calcSnV2()', () => {
  ...
  test('should return Sum(n) when input is valid', () => {
    expect(calcSnV2(3)).toBe(14);
    expect(calcSnV2(4)).toBe(30);
  });
});
...
describe('calcSnV3()', () => {
  ...
  test('should return Sum(n) when input is valid', () => {
    expect(calcSnV3(3)).toBe(14);
    expect(calcSnV3(4)).toBe(30);
  });
});
